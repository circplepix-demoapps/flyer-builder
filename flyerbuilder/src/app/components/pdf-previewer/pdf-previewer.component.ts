...
export class PDFPreviewerComponent implements OnInit, OnDestroy {
   ...
   constructor(private activatedRoute: ActivatedRoute, private router: Router, private pdf: PDFGeneratorService,
      private flyerLocalStorage: FlyerLocalStorageService) {
